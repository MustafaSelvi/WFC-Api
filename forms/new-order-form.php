<form class="ui form" method= "POST">
  ...
  -->
  <div class="ui green button" tabindex="0" id="manuel-order-opener">Proceed Manuel Order</div>
...
<?php     
      ...
      error_log($arr_body["orders"][0]["orderId"]);
      print_r($responseArray->getStatusCode());
      
      //  $response = $client->request('POST', 'http://ssapi.shipstation.com/orders/createorder', [
        
      //   'auth' => ['d1e596bee2f54be990e16e8dd6ddea3e', 'f34a64bccf8d4964aefa04fa586dce83'],
      //   'body' => [
      //             "orderNumber"=>  "Test-10",
      //             "orderKey"=> "0f6bec18-3e89-4881-83aa-ewrdsf1",
      //             "orderDate"=> "2015-06-29T08:46:27.0000000",
      //             "paymentDate"=> "2015-06-29T08:46:27.0000000",
      //             "shipByDate"=> "2015-07-05T00:00:00.0000000",
      //             "orderStatus"=> "awaiting_shipment",
